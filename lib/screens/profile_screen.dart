        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      onPressed: () => _checkAuthAndProceed(_showEditProfileSheet),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                child: UserManager().isLoggedIn ? Stack(
                  alignment: Alignment.center,
                  children: [
              ...
              ? RichText(
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      const TextSpan(text: ' (Kosmico Engineering & Development Team), combining modern mobile app architecture (Flutter & AI Vision) with ancient Ayurvedic wellness principles.'),
                    ],
                  ),
                )
              : Text(
